...
#print $conf "default_table_access_method = 'tde_heap'\n";
close $conf;
...
PGTDE::append_to_debug_file("--------cmdret------------");
PGTDE::append_to_debug_file($cmdret);
PGTDE::append_to_debug_file("--------stderr------------");
PGTDE::append_to_debug_file($stderr);
PGTDE::append_to_debug_file("--------------------");
PGTDE::append_to_debug_file("");
...
PGTDE::append_to_debug_file("--------------------");
PGTDE::append_to_debug_file("");
($cmdret, $stdout, $stderr) = $node->psql('postgres', "SET pgaudit.log = 'none'; CREATE EXTENSION IF NOT EXISTS postgis CASCADE; SET pgaudit.log = 'all';", extra_params => ['-a']);
