...
ppg_versions = {
        ...
        "12.20": {
            ...
            "percona-pgaudit12": pgaudit["12.20"],
            "percona-pg_repack12": pgrepack["12.20"],
            "percona-wal2json12": wal2json["12.20"],
            "percona-pgaudit12_set_user": set_user["12.20"],
            "percona-pg_stat_monitor12" : pg_stat_monitor["12.20"],
        ...
        "12.22": {
            ...
            "percona-pgaudit12": pgaudit["12.22"],
            "percona-pg_repack12": pgrepack["12.22"],
        ...
        "13.16": {
            ...
            "percona-pgaudit13": pgaudit["13.16"],
            "percona-pg_repack13": pgrepack["13.16"],
            "percona-wal2json13": wal2json["13.16"],
            "percona-pgaudit13_set_user": set_user["13.16"],
            "percona-pg_stat_monitor13" : pg_stat_monitor["13.16"],
        ...
        "13.18": {
            ...
            "percona-pgaudit13": pgaudit["13.18"],
            "percona-pg_repack13": pgrepack["13.18"],
        ...
        "14.13": {
            ...
            "percona-pgaudit14": pgaudit["14.13"],
            "percona-pg_repack14": pgrepack["14.13"],
            "percona-wal2json14": wal2json["14.13"],
            "percona-pgaudit14_set_user": set_user["14.13"],
            "percona-pg_stat_monitor14" : pg_stat_monitor["14.13"],
        ...
        "14.15": {
            ...
            "percona-pgaudit14": pgaudit["14.15"],
            "percona-pg_repack14": pgrepack["14.15"],
        ...
        "15.8": {
            ...
            "percona-pgaudit15": pgaudit["15.8"],
            "percona-pg_repack15": pgrepack["15.8"],
            "percona-wal2json15": wal2json["15.8"],
            "percona-pgaudit15_set_user": set_user["15.8"],
            "percona-pg_stat_monitor15" : pg_stat_monitor["15.8"],
        ...
        "15.10": {
            ...
            "percona-pgaudit15": pgaudit["15.10"],
            "percona-pg_repack15": pgrepack["15.10"],
        ...
        "16.4": {
            ...
            "percona-pgaudit16": pgaudit["16.4"],
            "percona-pg_repack16": pgrepack["16.4"],
            "percona-wal2json16": wal2json["16.4"],
            "percona-pgaudit16_set_user": set_user["16.4"],
            "percona-pg_stat_monitor16" : pg_stat_monitor["16.4"],
        ...
        "16.6": {
            ...
            "percona-pgaudit16": pgaudit["16.6"],
            "percona-pg_repack16": pgrepack["16.6"],
        ...
        "17.0": {
            ...
            "percona-pgaudit17": pgaudit["17.0"],
            "percona-pg_repack17": pgrepack["17.0"],
            "percona-wal2json17": wal2json["17.0"],
            "percona-pgaudit17_set_user": set_user["17.0"],
            "percona-pg_stat_monitor17" : pg_stat_monitor["17.0"],
            "libpq": "Version of libpq: 170000",
            "rpm_packages": fill_template_form(DOCKER_RPM_PACKAGES_TEMPLATE, "17.0"),
            "rhel_files": fill_template_form(DOCKER_RHEL_FILES_TEMPLATE, "17.0"),
            "extensions": DOCKER_LIST_EXTENSIONS,
            "binaries": ['clusterdb', 'createdb', 'createuser',
                        'dropdb', 'dropuser', 'pg_basebackup',
                        'pg_config', 'pg_dump', 'pg_dumpall',
        ...
        "17.2": {
            ...
            "percona-pgaudit17": pgaudit["17.2"],
            "percona-pg_repack17": pgrepack["17.2"],
        ...
        "17.4": {
            ...
            "percona-pgaudit17": pgaudit["17.4"],
            "percona-pg_repack17": pgrepack["17.4"],
            "percona-wal2json17": wal2json["17.4"],
            "percona-pgaudit17_set_user": set_user["17.4"],
            "percona-pg_stat_monitor17" : pg_stat_monitor["17.4"],
            "percona-pg-telemetry" : pg_telemetry["17.4"],
            "libpq": "Version of libpq: 170004",
            "rpm_packages": fill_template_form(DOCKER_RPM_PACKAGES_TEMPLATE, "17.4"),
            "rhel_files": fill_template_form(DOCKER_RHEL_FILES_TEMPLATE, "17.4"),
            "extensions": DOCKER_LIST_EXTENSIONS,
            "binaries": ['clusterdb', 'createdb', 'createuser',
                        'dropdb', 'dropuser', 'pg_basebackup',
                        'pg_config', 'pg_dump', 'pg_dumpall',
        ...
        "13.21": {
            ...
            "percona-pgaudit13": pgaudit["13.21"],
            "percona-pg_repack13": pgrepack["13.21"],
            "percona-wal2json13": wal2json["13.21"],
            "percona-pgaudit13_set_user": set_user["13.21"],
            "percona-pg_stat_monitor13" : pg_stat_monitor["13.21"],
            "percona-pg-telemetry" : pg_telemetry["13.21"],
        ...
        "14.18": {
            ...
            "percona-pgaudit14": pgaudit["14.18"],
            "percona-pg_repack14": pgrepack["14.18"],
            "percona-wal2json14": wal2json["14.18"],
            "percona-pgaudit14_set_user": set_user["14.18"],
            "percona-pg_stat_monitor14" : pg_stat_monitor["14.18"],
            "percona-pg-telemetry" : pg_telemetry["14.18"],
        ...
        "15.13": {
            ...
            "percona-pgaudit15": pgaudit["15.13"],
            "percona-pg_repack15": pgrepack["15.13"],
            "percona-wal2json15": wal2json["15.13"],
            "percona-pgaudit15_set_user": set_user["15.13"],
            "percona-pg_stat_monitor15" : pg_stat_monitor["15.13"],
            "percona-pg-telemetry" : pg_telemetry["15.13"],
        ...
        "16.9": {
            ...
            "percona-pgaudit16": pgaudit["16.9"],
            "percona-pg_repack16": pgrepack["16.9"],
            "percona-wal2json16": wal2json["16.9"],
            "percona-pgaudit16_set_user": set_user["16.9"],
            "percona-pg_stat_monitor16" : pg_stat_monitor["16.9"],
            "percona-pg-telemetry" : pg_telemetry["16.9"],
        ...
        "17.5": {
            ...
            "percona-pgaudit17": pgaudit["17.5"],
            "percona-pg_repack17": pgrepack["17.5"],
            "percona-wal2json17": wal2json["17.5"],
            "percona-pgaudit17_set_user": set_user["17.5"],
            "percona-pg_stat_monitor17" : pg_stat_monitor["17.5"],
            "percona-pg-telemetry" : pg_telemetry["17.5"],
            "libpq": "Version of libpq: 170005",
            "rpm_packages": fill_template_form(DOCKER_RPM_PACKAGES_TEMPLATE, "17.5"),
            "rhel_files": fill_template_form(DOCKER_RHEL_FILES_TEMPLATE, "17.5"),
            "extensions": DOCKER_LIST_EXTENSIONS,
            "binaries": ['clusterdb', 'createdb', 'createuser',
                        'dropdb', 'dropuser', 'pg_basebackup',
                        'pg_config', 'pg_dump', 'pg_dumpall',
